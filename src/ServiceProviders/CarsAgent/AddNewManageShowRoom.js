...
class AddNewManageShowRoom extends React.Component {
	state = {
		User_Type: '',
	...
	render() {
		return (
            <div className=''>
                <div>	<h4> Add New Manage ShowRoom</h4></div>
				{/* <h4> Add New Manage ShowRoom</h4> */}
...
export default AddNewManageShowRoom;
