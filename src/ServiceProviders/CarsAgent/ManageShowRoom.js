...
class ManageShowRoom extends React.Component {
	// constructor() {
	// 	super();
	// 	this.state = {};
	// }
							...
							<div className='col-sm-12'>
								<div className='card'>
									<div className='card-header'>
										...
										<Link
											to={`/ServiceProviders/Agent/AddNewManageShowRoom`}
											className='btn btn-sm btn-inverse waves-effect waves-light f-right d-inline-block md-trigger'
											data-modal='modal-13'>
											{' '}
											<i className='icofont icofont-plus m-r-5'></i>
											Add New Manage ShowRoom
										</Link>
									</div>
...
ManageShowRoom.propsTypes = {};

var mapStateToProps = state => ({
	home: state.home,
});

export default connect(mapStateToProps, {})(ManageShowRoom);
