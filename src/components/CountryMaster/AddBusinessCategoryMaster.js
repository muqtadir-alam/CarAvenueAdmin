...
class AddBusinessCategoryMaster extends React.Component {
	state = {
		User_Type: '',
	...
	render() {
		return (
			...
			<div className=''>
				<div className='col-md-6'>
                    <div className='form-group row'>
                        <h1>Add Business Category Master</h1>
             ...
             */}
						...
						{/* <div className='col-md-6'>
							<div className='row'>
								<div className='col-sm-3'>User Image</div>
								<div className='col-sm-9'> */}
						{/* <form
										id='userImage'
										name='userImage'
...
export default AddBusinessCategoryMaster;
