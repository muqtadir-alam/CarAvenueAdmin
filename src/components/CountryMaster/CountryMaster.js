...
class CountryMaster extends React.Component {
	...
	componentDidUpdate(prevProps) {
		...
		if (prevProps.location.pathname !== this.props.location.pathname) {
			...
			} else if (this.props.match.params.type === 'Country') {
	...
	render() {
		...
		if (this.props.match.params.type === 'Country') {
			columns = [
				{
					name: 'CountryName',
					label: 'Country Name',
		...
		} else if (this.props.match.params.type === 'CountryCode') {
			columns = [
				{
					name: 'CountryCode',
					label: 'Country Code',
							...
							<div className='col-sm-12'>
								<div className='card'>
									<div className='card-header'>
										...
										<Link
											to={`/CountryMaster/${this.props.match.params.type}/Add/${this.props.match.params.type}`}
...
CountryMaster.propsTypes = {};

var mapStateToProps = state => ({
	home: state.home,
});

export default connect(mapStateToProps, {})(CountryMaster);
