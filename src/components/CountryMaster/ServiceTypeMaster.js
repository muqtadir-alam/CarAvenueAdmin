...
class ServiceTypeMaster extends React.Component {
	// constructor() {
	// 	super();
	// 	this.state = {};
	// }
							...
							<div className='col-sm-12'>
								<div className='card'>
									<div className='card-header'>
										...
										<Link
											to={`/ServiceTypeMaster/AddServiceTypeMaster`}
											className='btn btn-sm btn-inverse waves-effect waves-light f-right d-inline-block md-trigger'
											data-modal='modal-13'>
											{' '}
											<i className='icofont icofont-plus m-r-5'></i>
											Add Service Type Master
										</Link>
									</div>
...
ServiceTypeMaster.propsTypes = {};

var mapStateToProps = state => ({
	home: state.home,
});

export default connect(mapStateToProps, {})(ServiceTypeMaster);
