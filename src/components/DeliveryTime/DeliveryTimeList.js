                ...
                <div className="card">
                  <div className="card-header">
                    ...
                    <Link to="/delivery-time/add"
                      className="btn btn-sm btn-inverse waves-effect waves-light f-right d-inline-block md-trigger" data-modal="modal-13"> <i className="icofont icofont-plus m-r-5"></i> Add Delivery Time
                       </Link>
                  </div>
                  <div className="card-block">
                    <div className="dt-responsive table-responsive">
                      <MUIDataTable
                        title={"Delivery Time List"}
...
export default connect(mapStateToProps, {  })(DeliveryTimeList);
